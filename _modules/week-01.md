...
: **Übung**{: .label .label-blue } erste ADTs: Liste, Stapel, Warteschlange, Tabelle
  ...
  : **Materialien:**
    - [📄 Algorithmik Übungsblatt1](/ba_algo_th_public/assets/slides/01_Algorithmik_Übungsblatt1.pdf) <span style="color: white; background-color: white;">datenstrukturen, abstrakte datentypen, algorithmik, warteschlange, o-notation</span>  
