...
: **Übung**{: .label .label-blue } Prioritätswarteschlange, Heap
  ...
  : **Materialien:**
    - [📄 Algorithmik Heaps](/ba_algo_th_public/assets/slides/07_Algorithmik_Heaps.pdf) <span style="font-size: 1px; color: white; background-color: white;">prioritätswarteschlange, binärer heap, heaps, datenstrukturen, algorithmen</span>  
